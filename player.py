...
class Player: 
    ...
    def update_combined_image(self):
        """Use the latest equipped upgrade image as the car image"""
        equipped_upgrades = [u for u in self.purchased_upgrades if u.equipped]
        if equipped_upgrades:
            # Gebruik de laatst equipped upgrade als de auto image
            latest_upgrade = equipped_upgrades[-1]
